...
{
  /*
  ASSUMINDO LDR 16-50  VALORES PARA R 33k e 3V  Min 0.98 V  Max: 1.8 V   AJUSTED FOR TOLERANCE MIN 0.95V AND MAX 2V   BUT THEN WE AJUST THIS SO THAT THE DIF IS 1024 TO EASE THE CALCULATIONS   SO THE FINAL VALUES ARE BELOW
   */
  //const int min = 900;
